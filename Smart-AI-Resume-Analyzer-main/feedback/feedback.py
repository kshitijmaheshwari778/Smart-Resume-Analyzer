...
class FeedbackManager:
    ...
    def save_feedback(self, feedback_data):
        ...
        document = {
            ...
            'usability_score': feedback_data['usability_score'],
            'feature_satisfaction': feedback_data['feature_satisfaction'],
    ...
    def get_feedback_stats(self):
        ...
        pipeline = [
            {"$group": {
                ...
                "avg_usability": {"$avg": "$usability_score"},
                "avg_satisfaction": {"$avg": "$feature_satisfaction"},
                "total": {"$sum": 1}
            }}
        ]
        ...
        if result:
            ...
            return {
                ...
                'avg_usability': r.get('avg_usability', 0),
                'avg_satisfaction': r.get('avg_satisfaction', 0),
                'total_responses': r.get('total', 0)
            }
        return {'avg_rating': 0, 'avg_usability': 0, 'avg_satisfaction': 0, 'total_responses': 0}
